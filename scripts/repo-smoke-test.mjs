...
assert(!r.body.projects.some((p) => p.name === '_governance' || p.name === '_snapshots' || p.name === 'skill仓库'), 'repoScan 排除治理/快照/技能目录')
...
assert(!r.body.dirs.includes('projA') && !r.body.dirs.includes('projB'), 'repoListDirs 排除项目目录（.git/package.json/.dsh）')
