      ...
      return h('div', { key: key, className: 'skm-svc-row ' + statusClass },
        ...
        h('div', { className: 'skm-svc-actions' },
          svc.port !== null && svc.port !== undefined
            ? h('button', { type: 'button', className: 'skm-btn', title: 'http://127.0.0.1:' + svc.port, onClick: function () { window.open('http://127.0.0.1:' + svc.port, '_blank', 'noopener') } }, t('service.open'))
            : null,
          svc.state === 'external'
