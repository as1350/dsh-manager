      ...
      port.repoScan().then(function (result) {
        ...
        if (paths.length > 0) {
          port.repoGitStates({ paths: paths }).then(function (gres) {
            if (gres !== null && typeof gres === 'object' && gres.states !== null && typeof gres.states === 'object') setGitStates(gres.states)
          }).catch(function () {})
        }
...
.skm-repo-grid { display:grid; grid-template-columns:repeat(2, minmax(0,1fr)); gap:10px; align-content:start; padding:2px; }
